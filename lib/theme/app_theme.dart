...
class AppTheme {
  ...
  static const Color surfaceLight = Color(0xFFFAFBFC); // Clean surface
  static const Color errorLight = Color(0xFFE76F51); // Muted red
  static const Color successLight = Color(0xFF52B788); // Clear green
  static const Color warningLight = Color(0xFFF4A261); // Amber
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight = Color(0xFF2D3748); // Text primary
  static const Color onSurfaceLight = Color(0xFF2D3748); // Text primary
  static const Color onErrorLight = Color(0xFFFFFFFF);

  static const Color primaryDark =
      Color(0xFF4A90A4); // Supporting blue as primary in dark
  static const Color primaryVariantDark =
      Color(0xFF3A7A8C); // Darker supporting blue
  static const Color secondaryDark =
      Color(0xFFE8A87C); // Warm coral as secondary
  static const Color secondaryVariantDark = Color(0xFFD4956A); // Darker coral
  static const Color accentDark = Color(0xFF52B788); // Success green as accent
  ...
  static const Color errorDark = Color(0xFFE76F51); // Muted red
  static const Color successDark = Color(0xFF52B788); // Clear green
  static const Color warningDark = Color(0xFFF4A261); // Amber
  static const Color onPrimaryDark = Color(0xFFFFFFFF);
  static const Color onSecondaryDark = Color(0xFF2D3748);
  ...
  static const Color dividerLight = Color(0xFFE2E8F0); // Border color
  static const Color dividerDark = Color(0xFF4A5568);

  // Text colors with proper hierarchy
  static const Color textPrimaryLight = Color(0xFF2D3748); // High contrast
  static const Color textSecondaryLight = Color(0xFF718096); // Supporting text
  static const Color textDisabledLight = Color(0xFFA0AEC0); // Disabled state

  static const Color textPrimaryDark = Color(0xFFFAFBFC); // High contrast
  static const Color textSecondaryDark = Color(0xFFE2E8F0); // Supporting text
  static const Color textDisabledDark = Color(0xFF718096); // Disabled state

  /// Light theme with Academic Clarity design
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for academic credibility
    ...
    // Bottom navigation for mobile-first students
    ...
    // Typography with Inter and optimized readability
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration for forms and academic data
    ...
    // Progress indicators for academic progress
    ...
    tooltipTheme: TooltipThemeData(
      decoration: BoxDecoration(
        color: Color(0xFF2D3748).withValues(alpha: 0.9),
        borderRadius: BorderRadius.circular(8.0),
      ),
      textStyle: GoogleFonts.inter(
  ...
  /// Dark theme with Academic Clarity design
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      onTertiaryContainer: Color(0xFFFAFBFC),
      error: errorDark,
      onError: onErrorDark,
      surface: surfaceDark,
    ...
    tooltipTheme: TooltipThemeData(
      decoration: BoxDecoration(
        color: Color(0xFFFAFBFC).withValues(alpha: 0.9),
        borderRadius: BorderRadius.circular(8.0),
      ),
      textStyle: GoogleFonts.inter(
  ...
  /// Helper method to build text theme with Inter font and academic hierarchy
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for assignment headers and navigation
